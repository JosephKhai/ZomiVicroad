...
import 'package:zomi_vicroad_learner/quiztext/VictoriaSpecificQuiz.dart';


var finalScore = 0;
var questionNumber = 0;
var quiz = new VictoriaSpecificQuiz();
var choiceNumber1 = 0;
var choiceNumber2 = 1;
var choiceNumber3 = 2;
...
class VictoriaSpecific extends StatefulWidget {
  @override
  _VictoriaSpecificState createState() => _VictoriaSpecificState();
}

class _VictoriaSpecificState extends State<VictoriaSpecific> {
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: Text(
          'Zomi Vicroad Learner',
          ...
          child: Column(
            children: <Widget>[
              ...
              Image.asset(
                ...
                height: quiz.images[questionNumber] == "blank" ? 0 : 180,
              ),
